...
{
    public class TransferGearbox1Case: TransferGearbox
    {
        public TransferGearbox1Case(Car car, GearwheelPair gearwheelPair1, GearwheelPair gearwheelPair2, Differential differential)
        ...
        public override void calc_allStep2()
        {
            ...
            calc_L1(gearwheelPair1.bf_shest);
            calc_L2(); 
        }
        ...
        public override void calc_allStep3()
        {
            ...
            calc_msh3(gearwheelPair2.d_kol, gearwheelPair1.bw);
            calc_mrk();
        }
        ...
        public void calc_L1(double bf_shest)
        {
            _L1 = bf_shest + 10;
        }
        ...
        public void calc_msh3(double d_kol2, double bw1)
        {
            _msh3 = Constants.pi * bw1 * (d_kol2 * d_kol2 - d3 * d3) * Constants.rho_steel * Math.Pow(10, -9) / 4;
        }
