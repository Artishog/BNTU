...
{
    public class TransferGearbox2Case: TransferGearbox
    {
        public TransferGearbox2Case(Car car, GearwheelPair gearwheelPair1, GearwheelPair gearwheelPair2, Differential differential)
        ...
        public override void calc_allStep3()
        {
            ...
            calc_H2();
            calc_B1(gearwheelPair2.d_kol, differential.d_korp);
            calc_B2();
            ...
            calc_msh3(gearwheelPair2.d_kol, gearwheelPair1.bw, differential.s);
        ...
        {
            _H1 = _aw1 + d_shest1 / 2 + _aw2 + Math.Max(d_korp, d_kol2) / 2 + 10;
        }
        ...
        public void calc_B1(double d_kol2, double d_korp)
        {
            _B1 = Math.Max(d_kol2, d_korp) + 10;
        }
        ...
        public void calc_msh3(double d_kol2, double bw1, double s)
        {
            _msh3 = Constants.pi * bw1 * (d_kol2 * d_kol2 - (d3 + 4 * s) * (d3 + 4 * s)) * Constants.rho_steel * Math.Pow(10, -9) / 4;
        }
