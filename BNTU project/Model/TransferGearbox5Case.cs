...
{
    public class TransferGearbox5Case : TransferGearbox
    {
        public TransferGearbox5Case(Car car, GearwheelPair gearwheelPair1, GearwheelPair gearwheelPair2, Differential differential)
        ...
        public override void calc_allStep2()
        {
            ...
            calc_L1(gearwheelPair1.bf_shest, gearwheelPair1.bw, gearwheelPair1.d_kol, differential.d_korp, differential.l1);
            calc_L2();
        }
        ...
        public override void calc_allStep3()
        {
            ...
            calc_H1(gearwheelPair1.d_shest, gearwheelPair1.d_kol, gearwheelPair2.d_kol, differential.d_korp);
            calc_H2();
            calc_B1(gearwheelPair1.d_kol, differential.d_korp);
            calc_B2();
            calc_m_korp();
            calc_d1();
            calc_d2();
            ...
            calc_msh3(gearwheelPair1.d_kol, gearwheelPair1.bw, differential.s);
        ...
        public void calc_H1(double d_shest1, double d_kol1, double d_kol2, double d_korp)
        {
            _H1 = _aw1 + d_kol1 / 2 + _aw2 + Math.Max(d_korp, d_kol1) / 2 + 10;
        }
        ...
        public void calc_B1(double d_kol1, double d_korp)
        {
            _B1 = Math.Max(d_kol1, d_korp) + 10;
        }
        ...
        public void calc_L1(double bf_shest1, double bw1, double d_kol1, double d_korp, double l1)
        {
            if ((_aw2 < (d_kol1 / 2 + d_korp / 2 + 3)) && (_Supr <= (l1 + 10)))
            {
                _L1 = l1 + bw1 + bf_shest1 + 20;
                return;
            }
        ...
        public void calc_msh3(double d_kol1, double bw1, double s)
        {
            _msh3 = Constants.pi * bw1 * (d_kol1 * d_kol1 - (d3 + 4 * s) * (d3 + 4 * s)) * Constants.rho_steel * Math.Pow(10, -9) / 4;
        }
