...
{
    public class TransferGearbox6Case : TransferGearbox
    {
        public TransferGearbox6Case(Car car, GearwheelPair gearwheelPair1, GearwheelPair gearwheelPair2, Differential differential)
        ...
        public override void calc_allStep2()
        {
            ...
            calc_L1(gearwheelPair1.bf_shest, differential.l1, gearwheelPair1.bw, gearwheelPair1.d_kol, differential.s, differential.d_korp);
            calc_L2();
        }
        ...
        public void calc_msh3(double d_kol1, double bw1, double d_korp)
        {
            _msh3 = Constants.pi * bw1 * (d_kol1 * d_kol1 - d_korp * d_korp) * Constants.rho_steel * Math.Pow(10, -9) / 4;
        }
